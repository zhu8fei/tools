 ...
 * @returns {Input}
 */
Input.prototype.call = function (method, data) {
    // 写入请求头
...
Input.prototype.write = function (data, type) {
    if (type)
 ...
 * @returns {Input}
 */
Input.prototype.writeObjectBody = function (data) {
    for (var arg in data) {
        if (arg == '__type__') {
            continue;
        }
 ...
 * @returns {Input}
 */
Input.prototype.writeListBegin = function (type, len) {
 ...
 * @returns {Input}
 */
Input.prototype.writeList = function (data) {
    var start = 0;
    var len, type, objs;
    type = data.__type__;
 ...
 * @param data
 */
Input.prototype.writeNull = function () {
...
Input.prototype.printString = function (data, offset, len) {
    for (var i = 0; i < len; ++i) {
...
Input.prototype.printBytes = function (data, offset, len) {
    for (var i = 0; i < len; i++) {
