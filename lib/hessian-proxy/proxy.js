...
var url = require('url'),
    ...
    Writer3 = require('./writer3'),
    Reader3 = require('./reader3');
...
Proxy.prototype.invoke = function(method, args, callback) {
    ...
    var self = this,
        WriterClz = (this.version === 1) ? Writer : (this.version === 2) ? Writer2 : Writer3,
        ReaderClz = (this.version === 1) ? Reader : (this.version === 2) ? Reader2 : Reader3;
